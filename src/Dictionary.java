...
public class Dictionary {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            // Turkce-Ingilizce Ceviri Islemleri. Sozluk secimi icin WordList sinifi, kelimeleri karsılıgı ile eslestirmek icin WordMatching sinifi kullaniliyor
            if (choice == 1) {
                System.out.println("#### Türkçe-İngilizce Sözlük ####");
                System.out.print("Kelime : ");
                String turkishWord = scanner.next();
                String english = wordMatch.wordMatcing(turkishWord,wordList.getTurkishWords);
                if (english != null) {
                ...
                String turkish = wordMatch.wordMatcing(englishWord,wordList.getEnglishWords);
                if (turkish != null) {
                ...
                while (true) {
                    ...
                    if(newChoice==1){
                        ...
                        newWord.addNewWord('\n'+trWord+"/"+trEngWord,"src/tureng.txt",wordList.getTurkishWords);
                        ...
                        newWord.addNewWord('\n'+engWord+'/'+engTWord,"src/engtur.txt", wordList.getEnglishWords);
